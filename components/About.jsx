...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Simar, Seasoned Full-Stack engineer experienced in developing applications, 
          databases, and cloud computing solutions. A smart professional with proven troubleshooting and debugging capabilities 
          for resolving complex technical issues, and a keen interest in AI and LLM model application development.
          <br className="sm:block hidden" />
          Let&apos;s collaborate to bring your ideas to life!
        </div>
        <div className="w-fit break-words">
          <Link
            href="mailto:workwithsimarsingh@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
        // TODO
          href="document/Simarpal Singh_Resume.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
