    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
          These are a selection of my freelance and hobby projects, serving as a testament to my practical skills and experience. While my work projects with my employer remain private, these ventures are open for exploration, each accompanied by descriptions and links to code repositories and live demos. They illustrate my capacity to navigate intricate challenges, adapt to diverse technologies, and oversee projects from inception to completion.
        </motion.p>
      </div>
